...
function AXFIconsMealMenuDuo(props: AXFIconProps) {
  return (
    <AXFIconComponent {...props}>
      <svg width='16' height='16' viewBox='0 0 16 16' fill='none' xmlns='http://www.w3.org/2000/svg'>
<path d='M7.5 12C9.433 12 11 10.6569 11 9C11 7.34315 9.433 6 7.5 6C5.567 6 4 7.34315 4 9C4 10.6569 5.567 12 7.5 12Z' fill='#FF0000' fillOpacity='0.3'/>
