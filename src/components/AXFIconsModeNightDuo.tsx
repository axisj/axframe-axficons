...
function AXFIconsModeNightDuo(props: AXFIconProps) {
  return (
    <AXFIconComponent {...props}>
      <svg width='16' height='16' viewBox='0 0 16 16' fill='none' xmlns='http://www.w3.org/2000/svg'>
<g clip-path='url(#clip0_7_1878)'>
<path fillRule='evenodd' clipRule='evenodd' d='M8 15C11.9 15 15 11.9 15 8C15 7.8 14.7 7.7 14.6 7.9C13.8 9.6 12.1 10.8 10.1 10.8C7.4 10.8 5.2 8.6 5.2 5.9C5.2 3.9 6.4 2.2 8.1 1.4C8.3 1.3 8.2 1 8 1C4.1 1 1 4.1 1 8C1 11.9 4.1 15 8 15Z' fill='#FF0000' fillOpacity='0.3'/>
