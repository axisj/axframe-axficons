...
function AXFIconsMealTranDuo(props: AXFIconProps) {
  return (
    <AXFIconComponent {...props}>
      <svg width='16' height='16' viewBox='0 0 16 16' fill='none' xmlns='http://www.w3.org/2000/svg'>
<path d='M6 1V6C8.2 6 10 7.8 10 10C10 12.2 8.2 14 6 14H14V1H6Z' fill='#FF0000' fillOpacity='0.3'/>
