...
function AXFIconsManageManagerDuo(props: AXFIconProps) {
  return (
    <AXFIconComponent {...props}>
      <svg width='16' height='16' viewBox='0 0 16 16' fill='none' xmlns='http://www.w3.org/2000/svg'>
<g clipPath='url(#clip0_7_1562)'>
<path d='M7.5 6C8.88071 6 10 4.88071 10 3.5C10 2.11929 8.88071 1 7.5 1C6.11929 1 5 2.11929 5 3.5C5 4.88071 6.11929 6 7.5 6Z' fill='#FF0000' fillOpacity='0.3'/>
<path fillRule='evenodd' clipRule='evenodd' d='M12 9C11.2 9 10.5 9.3 10 9.8V9.5C10 8.1 8.9 7 7.5 7C6.1 7 5 8.1 5 9.5V13H9.2C9.6 14.2 10.7 15 12 15C13.7 15 15 13.7 15 12C15 10.3 13.7 9 12 9Z' fill='#FF0000' fillOpacity='0.3'/>
...
export { AXFIconsManageManagerDuo };
