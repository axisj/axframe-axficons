...
function AXFIconsRadiobuttonBlock(props: AXFIconProps) {
  return (
    <AXFIconComponent {...props}>
      <svg width='16' height='16' viewBox='0 0 16 16' fill='none' xmlns='http://www.w3.org/2000/svg'>
<g clipPath='url(#clip0_7_938)'>
<path d='M12.6 4L4 12.6C5.1 13.5 6.5 14.1 8 14.1C11.4 14.1 14.1 11.4 14.1 8C14.1 6.5 13.6 5.1 12.6 4Z' fill='black'/>
<path d='M7.99999 1.90002C4.59999 1.90002 1.89999 4.60002 1.89999 8.00002C1.89999 9.50002 2.49999 10.9 3.39999 12L12 3.40002C10.9 2.40002 9.49999 1.90002 7.99999 1.90002Z' fill='black'/>
...
export { AXFIconsRadiobuttonBlock };
