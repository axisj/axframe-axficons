...
function AXFIconsDepartmentDuo(props: AXFIconProps) {
  return (
    <AXFIconComponent {...props}>
      <svg width='16' height='16' viewBox='0 0 16 16' fill='none' xmlns='http://www.w3.org/2000/svg'>
<path d='M11 7V3.8L8 2L5 3.8V7L2 8.8V12.2L5 14L8 12.2L11 14L14 12.2V8.8L11 7Z' fill='#FF0000' fillOpacity='0.3'/>
...
<path d='M5 11C5.55228 11 6 10.5523 6 10C6 9.44772 5.55228 9 5 9C4.44772 9 4 9.44772 4 10C4 10.5523 4.44772 11 5 11Z' fill='black'/>
<path d='M11 11C11.5523 11 12 10.5523 12 10C12 9.44772 11.5523 9 11 9C10.4477 9 10 9.44772 10 10C10 10.5523 10.4477 11 11 11Z' fill='black'/>
</svg>

    </AXFIconComponent>
  );
}
export { AXFIconsDepartmentDuo };
