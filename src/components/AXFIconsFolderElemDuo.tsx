...
function AXFIconsFolderElemDuo(props: AXFIconProps) {
  return (
    <AXFIconComponent {...props}>
      <svg width='16' height='16' viewBox='0 0 16 16' fill='none' xmlns='http://www.w3.org/2000/svg'>
<g clipPath='url(#clip0_7_3075)'>
<path d='M1 4V15H15V4H1ZM12 13H7V11H5V6H10V8H12V13Z' fill='#FF0000' fillOpacity='0.3'/>
