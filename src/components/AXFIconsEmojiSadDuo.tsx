...
function AXFIconsEmojiSadDuo(props: AXFIconProps) {
  return (
    <AXFIconComponent {...props}>
      <svg width='16' height='16' viewBox='0 0 16 16' fill='none' xmlns='http://www.w3.org/2000/svg'>
<g clipPath='url(#clip0_7_1380)'>
<path d='M8 1C4.1 1 1 4.1 1 8C1 10.4 2.2 12.5 4 13.7V6H6V14.7C6.6 14.9 7.3 15 8 15C8.7 15 9.4 14.9 10 14.7V6H12V13.7C13.8 12.4 15 10.3 15 8C15 4.1 11.9 1 8 1Z' fill='#FF0000' fillOpacity='0.3'/>
