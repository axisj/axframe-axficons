...
function AXFIconsDocsDuo(props: AXFIconProps) {
  return (
    <AXFIconComponent {...props}>
      <svg width='16' height='16' viewBox='0 0 16 16' fill='none' xmlns='http://www.w3.org/2000/svg'>
<path d='M4 2H13C13.6 2 14 2.5 14 3V14C14 14.6 13.6 15 13 15H4C3.5 15 3 14.6 3 14V3C3 2.5 3.5 2 4 2Z' fill='#FF0000' fillOpacity='0.3'/>
