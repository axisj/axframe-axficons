...
function AXFIconsStaticsCalcDuo(props: AXFIconProps) {
  return (
    <AXFIconComponent {...props}>
      <svg width='16' height='16' viewBox='0 0 16 16' fill='none' xmlns='http://www.w3.org/2000/svg'>
<path d='M7.99998 13C10.4 13 12.4 11.3 12.9 9H3.09998C3.59998 11.3 5.59998 13 7.99998 13Z' fill='#FF0000' fillOpacity='0.3'/>
<path d='M13 2H9.99998V4H13V2Z' fill='#FF0000' fillOpacity='0.3'/>
