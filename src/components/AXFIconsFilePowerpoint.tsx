...
function AXFIconsFilePowerpoint(props: AXFIconProps) {
  return (
...
<path fillRule='evenodd' clipRule='evenodd' d='M8 15V1L1 3V13L8 15ZM2.4 4.9H4.6C5.2 4.9 5.7 5.1 6.1 5.4C6.5 5.8 6.7 6.2 6.7 6.8C6.7 7.4 6.5 7.9 6.2 8.2C5.7 8.6 5.2 8.8 4.5 8.8H3.4V11.1H2.4V4.9Z' fill='black'/>
