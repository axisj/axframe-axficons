...
function AXFIconsApprovalDuo(props: AXFIconProps) {
  return (
    <AXFIconComponent {...props}>
      <svg width='16' height='16' viewBox='0 0 16 16' fill='none' xmlns='http://www.w3.org/2000/svg'>
<path d='M2 1V15H14V1H2ZM9 11V13H4V11H5V7.5C4.4 7 4 6.3 4 5.5C4 4.1 5.1 3 6.5 3C7.9 3 9 4.1 9 5.5C9 6.3 8.6 7 8 7.5V11H9Z' fill='#FF0000' fillOpacity='0.3'/>
