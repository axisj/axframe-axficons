...
function AXFIconsClassDuo(props: AXFIconProps) {
  return (
    <AXFIconComponent {...props}>
      <svg width='16' height='16' viewBox='0 0 16 16' fill='none' xmlns='http://www.w3.org/2000/svg'>
<path d='M13 3H3V5H13V3Z' fill='#FF0000' fillOpacity='0.3'/>
<path d='M13 11H3V13H13V11Z' fill='#FF0000' fillOpacity='0.3'/>
