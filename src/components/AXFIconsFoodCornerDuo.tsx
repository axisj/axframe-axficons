...
function AXFIconsFoodCornerDuo(props: AXFIconProps) {
  return (
    <AXFIconComponent {...props}>
      <svg width='16' height='16' viewBox='0 0 16 16' fill='none' xmlns='http://www.w3.org/2000/svg'>
<path d='M11 6H10V7H8V6H7V7H5V6H4V7H2V14H3V12H5V10H10V12H12V14H13V7H11V6Z' fill='#FF0000' fillOpacity='0.3'/>
<path d='M11 3V1H4V3H2V5H13V3H11Z' fill='#FF0000' fillOpacity='0.3'/>
