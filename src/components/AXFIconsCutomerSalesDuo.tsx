...
function AXFIconsCutomerSalesDuo(props: AXFIconProps) {
  return (
    <AXFIconComponent {...props}>
      <svg width='16' height='16' viewBox='0 0 16 16' fill='none' xmlns='http://www.w3.org/2000/svg'>
<g clipPath='url(#clip0_7_1338)'>
<path d='M8 10V3H6V5.8C5.6 5.3 5.1 5 4.5 5C3.4 5 2.6 5.9 2.6 7.1C2.6 7.7 2.8 8.3 3.2 8.6C3.4 8.8 3.5 9.1 3.4 9.4C3.3 9.8 3.1 10 2.8 10.1C1.8 10.3 1 11.3 1 12.5V14.2C1 14.6 1.3 15 1.8 15H8V12.5C8 11.9 7.8 11.4 7.5 11H12V10H8Z' fill='#FF0000' fillOpacity='0.3'/>
...
export { AXFIconsCutomerSalesDuo };
