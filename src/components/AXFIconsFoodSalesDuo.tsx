...
function AXFIconsFoodSalesDuo(props: AXFIconProps) {
  return (
    <AXFIconComponent {...props}>
      <svg width='16' height='16' viewBox='0 0 16 16' fill='none' xmlns='http://www.w3.org/2000/svg'>
<path d='M16 3V1H12V11H3V4H0V15H14V12H16V9C14.3 9 13 7.7 13 6C13 4.3 14.3 3 16 3Z' fill='#FF0000' fillOpacity='0.3'/>
