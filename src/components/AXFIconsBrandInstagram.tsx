...
function AXFIconsBrandInstagram(props: AXFIconProps) {
  return (
...
<path d='M12 4.9C12.4418 4.9 12.8 4.54183 12.8 4.1C12.8 3.65817 12.4418 3.3 12 3.3C11.5582 3.3 11.2 3.65817 11.2 4.1C11.2 4.54183 11.5582 4.9 12 4.9Z' fill='black'/>
</svg>

    </AXFIconComponent>
  );
}
export { AXFIconsBrandInstagram };
